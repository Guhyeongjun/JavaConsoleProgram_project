...
public class FortuneController {
	...
	public void deleteFortune() {
		...
		//실행할려면 1, 취소할려면 2를 누르기
		int checkIndex = fortuneView.getDeleteCheck();
		//인덱스 값을 주고 운세 하나를 배열에서 삭제
		fortuneService.deleteFortune(index, checkIndex);
	}
	...
	public void updateFortune() {
		...
		//실행할려면 1, 취소할려면 2를 누르기
		int checkIndex = fortuneView.getUpdateCheck();
		//인덱스 값을 가지고 배열에서 수정
		fortuneService.updateFortune(index, fortuneStr, checkIndex);
	}
